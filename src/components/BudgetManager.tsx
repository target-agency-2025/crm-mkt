...
const BudgetManager: React.FC = () => {
  const { budgets, budgetPlans, addBudget, updateBudget, deleteBudget: deleteBudgetFromContext, addBudgetPlan, updateBudgetPlan, deleteBudgetPlan } = useCRM();
